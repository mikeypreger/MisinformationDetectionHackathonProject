...
# 🚨 CRITICAL FIX: Tell Python exactly where to look before importing anything else
current_file = Path(__file__).resolve()
sys.path.insert(0, str(current_file.parent.parent))        # Adds the 'astrodetect' folder
sys.path.insert(0, str(current_file.parent.parent.parent)) # Adds the main project root folder
